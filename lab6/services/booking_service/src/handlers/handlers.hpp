...
private:
  ...
  BookingStore store_;
  const BookingEventPublisher& events_;
};
...
public:
  ...
  BookingListHandler(const components::ComponentConfig& config, const components::ComponentContext& context);
...
public:
  ...
  BookingCancelHandler(const components::ComponentConfig& config, const components::ComponentContext& context);
